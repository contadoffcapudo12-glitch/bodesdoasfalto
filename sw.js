        ...
        return fetch(event.request)
          ...
          .catch((error) => {
            ...
            if (event.request.destination === 'image') {
              return new Response(
                '<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200"><rect width="200" height="200" fill="#f0f0f0"/><text x="50%" y="50%" text-anchor="middle" dy=".3em" fill="#999">Imagem indisponível</text></svg>',
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: event.data ? event.data.text() : 'Nova notificação dos Bodes do Asfalto!',
...
console.log('🏍️ Bodes do Asfalto Service Worker loaded successfully! 🏍️');